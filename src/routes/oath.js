    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, axios_1["default"].post(url, querystring_1["default"].stringify(refreshTokenProof))];
            case 1:
                resp = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, axios_1["default"].post(url, querystring_1["default"].stringify(tokenProof))];
            case 1:
                resp = _a.sent();
                return [2 /*return*/, resp.data];
            case 2:
...
router.get('/oauth-callback', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, axios_1["default"].post('https://api.hubapi.com/oauth/v1/token', querystring_1["default"].stringify(authCodeProof))];
            case 2:
                resp = _a.sent();
                if (resp.status != 200) {
